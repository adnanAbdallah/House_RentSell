...
--Create User
--------------------------
IF not exists (select Id from Userss where Username='Demo')
insert into Userss(Username,Password, PasswordKey,LastUpdatedOn,LastUpdatedBy)
select 'Demo',
...
SET @UserID = (select id from Userss where Username='Demo')
